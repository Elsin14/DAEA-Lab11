...
namespace DAEA_Lab11.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InstructorID,Location,Enable")] OfficeAssignment officeAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InstructorID,Location,Enable")] OfficeAssignment officeAssignment)
        {
            if (ModelState.IsValid)
            {
